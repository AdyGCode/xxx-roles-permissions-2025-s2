  ...
  md:gap-4 lg:px-8 lg:py-32">
                    <div class="max-w-prose text-left mx-8">
                        ...
                        <ul class="mt-4 text-base text-pretty text-gray-700 dark:text-gray-400 sm:text-lg/relaxed">
                            ...
                            <li class="list-disc ml-8"><code class="font-mono">can</code>, <code class="font-mono">cannot</code>,
                                and other Blade
                                template
                                macros
                            </li>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800.158 482.261"
                        ...
                        <g transform="translate(-542.001 -294)">
                            <path
                                ...
                                transform="translate(888.688 277.632)" fill="#ed9da0"/>
                            <path
                                d="M194.7,214.788s100.685,16.977,113.969,37.347,27.454,49.6,27.454,49.6,38.082,189.525-22.141,216.093l-243.27-34.69,29.834-89.3L70.437,483.284,0,472.009s42.1-208.36,66.009-222.531,53.8-10.362,53.8-10.362,47.6,47.3,74.391-24.309l.5-.019Z"
                                transform="translate(994.157 258.437)" fill="#e6e6e6"/>
                            <path
                                d="M262.378,75.429s-21.306,6.547-30.163-4.081c0,0-21.255.886-25.683,12.4s-31,16.827-39.853,7.085-22.141-27.454-5.314-43.4c0,0,2.657-16.827,16.827-20.369l7.971,7.085s105.28-49.512,117.733.927c0,0,19.065-3.594,10,7.924,0,0,10.211,11.84,16.689,34.293a92.568,92.568,0,0,1-29.9,96.635h0s22.64-59.428,3.211-42.037-18.543-22.463-18.543-22.463-29.123-17.521-22.975-34Z"
                                transform="translate(872.232 281.582)" fill="#090814"/>
                            <path
                                d="M206.2,426.475l148.185,78.961,28.491-42.01L228.015,385.749c-3.229-11.306-11.735-22.008-24.162-28.663-21.743-11.645-47.181-6.5-56.818,11.5s.176,42.021,21.919,53.666c12.426,6.655,26.048,7.8,37.249,4.227Z"
                                transform="translate(832.34 242.874)" fill="#ed9da0"/>
                            <path
                                d="M162.808,396.958l7.085,21.255s-16.827,17.967,0,28.025l-59.337-7.655s-24.022-17.717-25.738-3.1c0,0-30.056-19.924-36.256-7.525,0,0,17.777,38.441-10.153,58.188l37.164,16.711,26.471,17.915L224.8,538.659"
                                transform="translate(1083.339 237.603)" fill="#e6e6e6"/>
